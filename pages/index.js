      ...
      <div className="grid grid-rows-1 pt-4 pb-4">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="text-center">
            <div className="text-3xl md:text-6xl md:text-center drop-shadow-lg font-semibold text-gray-700 pb-2">Abraham Camargo</div>
            <div className="text-white text-md md:text-3xl pt-1 font-semibold drop-shadow-lg">Systems Administrator / Full Stack Web Developer</div>
